...
(cl:defmethod cl:initialize-instance :after ((m <ClosestPointPath-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ClosestPointPath-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name p4-srv:<ClosestPointPath-request> is deprecated: use p4-srv:ClosestPointPath-request instead.")))

(cl:ensure-generic-function 'robot_position-val :lambda-list '(m))
(cl:defmethod robot_position-val ((m <ClosestPointPath-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p4-srv:robot_position-val is deprecated.  Use p4-srv:robot_position instead.")
  (robot_position m))
...
(cl:defmethod cl:initialize-instance :after ((m <ClosestPointPath-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ClosestPointPath-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name p4-srv:<ClosestPointPath-response> is deprecated: use p4-srv:ClosestPointPath-response instead.")))

(cl:ensure-generic-function 'closest_point-val :lambda-list '(m))
(cl:defmethod closest_point-val ((m <ClosestPointPath-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p4-srv:closest_point-val is deprecated.  Use p4-srv:closest_point instead.")
  (closest_point m))

(cl:ensure-generic-function 'path_position-val :lambda-list '(m))
(cl:defmethod path_position-val ((m <ClosestPointPath-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p4-srv:path_position-val is deprecated.  Use p4-srv:path_position instead.")
  (path_position m))

(cl:ensure-generic-function 'dist_to_path-val :lambda-list '(m))
(cl:defmethod dist_to_path-val ((m <ClosestPointPath-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p4-srv:dist_to_path-val is deprecated.  Use p4-srv:dist_to_path instead.")
  (dist_to_path m))
