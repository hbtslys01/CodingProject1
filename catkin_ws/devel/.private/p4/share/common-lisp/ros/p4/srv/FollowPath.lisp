...
(cl:defmethod cl:initialize-instance :after ((m <FollowPath-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FollowPath-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name p4-srv:<FollowPath-request> is deprecated: use p4-srv:FollowPath-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <FollowPath-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FollowPath-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name p4-srv:<FollowPath-response> is deprecated: use p4-srv:FollowPath-response instead.")))
