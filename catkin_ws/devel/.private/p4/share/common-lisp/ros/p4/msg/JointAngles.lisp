...
(cl:defmethod cl:initialize-instance :after ((m <JointAngles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointAngles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name p4-msg:<JointAngles> is deprecated: use p4-msg:JointAngles instead.")))

(cl:ensure-generic-function 'angles-val :lambda-list '(m))
(cl:defmethod angles-val ((m <JointAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p4-msg:angles-val is deprecated.  Use p4-msg:angles instead.")
  (angles m))
