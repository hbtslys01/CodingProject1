...
(cl:defmethod cl:initialize-instance :after ((m <InterpolatePath-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InterpolatePath-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name p4-srv:<InterpolatePath-request> is deprecated: use p4-srv:InterpolatePath-request instead.")))
...
(cl:defmethod distance-val ((m <InterpolatePath-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p4-srv:distance-val is deprecated.  Use p4-srv:distance instead.")
  (distance m))
...
(cl:defmethod cl:initialize-instance :after ((m <InterpolatePath-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InterpolatePath-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name p4-srv:<InterpolatePath-response> is deprecated: use p4-srv:InterpolatePath-response instead.")))

(cl:ensure-generic-function 'point-val :lambda-list '(m))
(cl:defmethod point-val ((m <InterpolatePath-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p4-srv:point-val is deprecated.  Use p4-srv:point instead.")
  (point m))
