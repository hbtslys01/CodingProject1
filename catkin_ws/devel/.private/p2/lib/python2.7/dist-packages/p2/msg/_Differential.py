...
"""autogenerated by genpy from p2/Differential.msg. Do not edit."""
import sys
...
class Differential(genpy.Message):
  _md5sum = "6276768e5df1d6b78b96e63931fb03fc"
  _type = "p2/Differential"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """float64 left_vel
float64 right_vel
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Differential, self).__init__(*args, **kwds)
