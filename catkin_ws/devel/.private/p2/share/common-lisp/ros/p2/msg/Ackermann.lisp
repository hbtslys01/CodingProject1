...
(cl:defmethod cl:initialize-instance :after ((m <Ackermann>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Ackermann)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name p2-msg:<Ackermann> is deprecated: use p2-msg:Ackermann instead.")))

(cl:ensure-generic-function 'steering_angle-val :lambda-list '(m))
(cl:defmethod steering_angle-val ((m <Ackermann>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2-msg:steering_angle-val is deprecated.  Use p2-msg:steering_angle instead.")
  (steering_angle m))

(cl:ensure-generic-function 'vel-val :lambda-list '(m))
(cl:defmethod vel-val ((m <Ackermann>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader p2-msg:vel-val is deprecated.  Use p2-msg:vel instead.")
  (vel m))
